...
{
    public partial class ReportBarang026 : Form
    {
        public ReportBarang026()
        {
            InitializeComponent();
        }
        ...
        private void exportgridtoexcel(DataGridView dgw, string filename)
        {
            ...
            saveFileDialogeExcel.FileName = "Quiz Report";
        ...
        private void ReportBarang026_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'quizMahasiswaDataSet.tbl_barang' table. You can move, or remove it, as needed.
            this.tbl_barangTableAdapter.Fill(this.quizMahasiswaDataSet1.tbl_barang);

        }

        private void button1_Click(object sender, EventArgs e)
        {
            exportgridtopdf(dataGridView1, "Quiz Report");
        }
